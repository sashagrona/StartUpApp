    ...
    <main class="form-horizontal" style="width: 72%;margin: 50px;background-color: #00b7f7;opacity: 100;">
        <div class="container-fluid">
            ...
            <div class="list-group">
                <c:forEach items="${startups}" var="s">
                    <div class="list-group-item"><a href="/startup/${s.name}"><h2 style="font-size: 40px;float: left;">
                        <c:out value="${s.name}"></c:out></h2></a>
                        <c:if test="${s.creator.email eq email}">
                            <button class="btn btn-danger" style="float: right; margin-top: 10px;" id="delete"
                                    onclick="deleteObject('${s.name}', '/startup/delete' , '/create_startup')">Delete
                                StartUp
                            </button>
                        </c:if>
                    </div>
            ...
            <button class="buttons btn-hover color-1" data-toggle="modal" data-target="#addModal">Add StartUp</button>


        </div>
    </main>
</div>
<%--Modal window for creating new start up--%>
<div id="addModal" class="modal fade form-group" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" align="center">My New StartUp</h4>
            </div>
            <div class="modal-body" align="center">

                <input class="form-control" type="text" id="startText" placeholder="StartUp Name"/>

                <span class="requirements" id="nameSpan"></span><br>

                <input class="form-control" type="text" id="startIdea" placeholder="Describe main idea"/>
                <span class="requirements" id="ideaSpan"></span><br>

                <input type="button" class="btn btn-success" id="submitButton" value="Create StartUp"/><br><br>
