        ...
        <div class="container-fluid"><br>
            ...
            <c:if test="${admin eq true}">
                ...
                <form action="/admin" method="post">
                    <p>Notice, that to use admin page you should be logged in via Login Form(not via other
                        apps)</p>
            ...
            <h1 style="font-size: 30px">StartUpApp it's an app, where you can create your own start-up,
                ...
                creating and developing your business. Also you have opportunity to create business-plan and
                follow the tasks
                you're adding and you can save necessary documents here as well. So, all you need is to
                "Find friends" and create a start-up in a "My StartUps". Create your team and go for it!
            </h1>
